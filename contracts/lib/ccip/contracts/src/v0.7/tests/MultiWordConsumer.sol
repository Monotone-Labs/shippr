...
contract MultiWordConsumer is ChainlinkClient {
    ...
    function requestMultipleParametersWithCustomURLs(
        ...
        Chainlink.Request memory req =
            buildOperatorRequest(specId, this.fulfillMultipleParametersWithCustomURLs.selector);
    ...
    function fulfillMultipleParametersWithCustomURLs(bytes32 _requestId, uint256 _usd, uint256 _eur, uint256 _jpy)
        public
        recordChainlinkFulfillment(_requestId)
    {
