...
library CheckedMath {
    int256 internal constant INT256_MIN = -2 ** 255;

    /**
     * @dev Subtracts two signed integers, returns false 2nd param on overflow.
     */
    function add(int256 a, int256 b) internal pure returns (int256 result, bool ok) {
        int256 c = a + b;
     ...
     * @dev Subtracts two signed integers, returns false 2nd param on overflow.
     */
    function sub(int256 a, int256 b) internal pure returns (int256 result, bool ok) {
        int256 c = a - b;
        if ((b < 0 && c <= a) || (b >= 0 && c > a)) return (0, false);
     ...
     */
    function mul(int256 a, int256 b) internal pure returns (int256 result, bool ok) {
     ...
     */
    function div(int256 a, int256 b) internal pure returns (int256 result, bool ok) {
