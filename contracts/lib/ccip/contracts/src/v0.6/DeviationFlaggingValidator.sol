...
contract DeviationFlaggingValidator is Owned, AggregatorValidatorInterface {
     ...
     */
    function validate(uint256 _previousRoundId, int256 _previousAnswer, uint256 _roundId, int256 _answer)
        external
        override
        returns (bool)
    {
     ...
     */
    function isValid(uint256, int256 _previousAnswer, uint256, int256 _answer) public view returns (bool) {
