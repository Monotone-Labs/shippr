...
contract MaliciousRequester is MaliciousChainlinked {
    ...
    function maliciousWithdraw() public {
        MaliciousChainlink.WithdrawRequest memory req = newWithdrawRequest("specId", this, this.doesNothing.selector);
    ...
    function maliciousRequestCancel(bytes32 _id, bytes _callbackFunc) public {
        ...
        oracle.cancelOracleRequest(
            request(_id, this, _callbackFunc), ORACLE_PAYMENT, this.maliciousRequestCancel.selector, expiration
        );
    }
