...
contract ChainlinkClient {
    ...
    address private constant SENDER_OVERRIDE = 0x0;
     ...
     */
    function cancelChainlinkRequest(bytes32 _requestId, uint256 _payment, bytes4 _callbackFunc, uint256 _expiration)
        internal
    {
