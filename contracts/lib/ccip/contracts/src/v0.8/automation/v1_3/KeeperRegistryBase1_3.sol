...
abstract contract KeeperRegistryBase1_3 is ConfirmedOwner, ExecutionPrevention, ReentrancyGuard, Pausable {
     ...
     */
    function _calculatePaymentAmount(uint256 gasLimit, uint256 fastGasWei, uint256 linkEth, bool isExecution)
        internal
        view
     ...
     */
    function _generatePerformParams(address from, uint256 id, bytes memory performData, bool isExecution)
        internal
        view
