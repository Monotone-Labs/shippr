...
contract BatchVRFCoordinatorV2Plus {
     ...
     */
    function fulfillRandomWords(VRFTypes.Proof[] memory proofs, VRFTypes.RequestCommitmentV2Plus[] memory rcs)
        external
    {
...
interface IVRFCoordinatorV2Plus {
    function fulfillRandomWords(VRFTypes.Proof memory proof, VRFTypes.RequestCommitmentV2Plus memory rc)
        external
        returns (uint96);
}
