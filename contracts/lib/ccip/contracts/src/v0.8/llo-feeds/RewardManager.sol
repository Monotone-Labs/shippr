...
contract RewardManager is IRewardManager, ConfirmedOwner, TypeAndVersionInterface {
        ...
        for (uint256 i; i < poolIds.length; ++i) {
            ...
            unchecked {
                ...
                uint256 claimableAmount =
                    totalFeesInPot - s_totalRewardRecipientFeesLastClaimedAmounts[poolId][recipient];
                ...
                uint256 recipientShare =
                    (claimableAmount * s_rewardRecipientWeights[poolId][recipient]) / PERCENTAGE_SCALAR;
    ...
    /// @inheritdoc IRewardManager
    function updateRewardRecipients(bytes32 poolId, Common.AddressAndWeight[] calldata newRewardRecipients)
        external
        override
        onlyOwner
    {
