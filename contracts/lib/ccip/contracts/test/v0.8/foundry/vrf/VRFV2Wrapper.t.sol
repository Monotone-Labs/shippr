...
import {VRFV2PlusWrapperConsumerExample} from
    "../../../../src/v0.8/dev/vrf/testhelpers/VRFV2PlusWrapperConsumerExample.sol";
...
contract VRFV2PlusWrapperTest is BaseTest {
    ...
    function testRequestAndFulfillRandomWordsNativeWrapper() public {
        ...
        (uint256 requestId, uint256 preSeed) =
            s_testCoordinator.computeRequestIdExternal(vrfKeyHash, address(s_wrapper), s_wrapper.SUBSCRIPTION_ID(), 2);
